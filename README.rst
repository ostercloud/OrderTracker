...
.. code-block:: bash
    ...
    heroku run python OrderTracker/manage.py syncdb --noinput --settings=config.settings
    heroku run python OrderTracker/manage.py migrate --settings=config.settings
    heroku run python OrderTracker/manage.py collectstatic --settings=config.settings
